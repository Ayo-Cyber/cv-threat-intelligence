...
METHODS = set('auth_state create_first_owner sign_in sign_out get_site set_site list_cameras add_camera remove_camera test discover_cameras detect_subnet scan list_areas create_area assign_camera_area scene_context scene_review_summary area_context approve_area_context approve_site_context update_scene_context approve_scene_context request_scene_remap enqueue_scene_mapping scene_mapping_progress accept_suggested_zone camera_snapshot list_zones add_zone remove_zone set_camera_rules object_targets create_object_target set_object_watch_runtime_config reembed_object_targets add_object_example review_object_example object_example_preview activate_object_target deactivate_object_target object_watch_job_status set_object_watch_rule presets use_case_templates apply_template add_custom_rule remove_custom_rule english_rules_status list_events event_clip acknowledge_alert resolve_alert search_events live_start camera_links start_monitoring stop_monitoring monitoring_status feed_sources switch_feed feed_switch_status setup_state setup_check mark_configured send_test_notification gate_status pull_model pull_progress retention_status set_retention list_users add_user remove_user audit_entries backup_now download_diagnostics value_summary role_table disk_encryption auth_accounts auth_recovery change_own_password set_user_role create_owner_override counts needs_attention export_incident_pdf export_evidence set_legal_hold weekly_summary handover list_backups restore_backup set_backup_dir audit_export audit_verify app_version detector_validation heartbeat_status set_heartbeat learning_stats learning_calibrate set_value_inputs live_frames set_custom_rule add_custom_threat remove_custom_threat update_site_context'.split())
