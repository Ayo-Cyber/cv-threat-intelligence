...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--gate-provider", default="mock", choices=("mock", "anthropic", "openrouter"))
    p.add_argument("--gate-model", default="", help="Override gate model; empty = provider default "
                   "(claude-sonnet-4-6 for anthropic, google/gemma-4-26b-a4b-it:free for openrouter).")
